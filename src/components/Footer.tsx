      ...
      <div className="container mx-auto px-6 py-16 sm:py-24">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul role="list" className="mt-6 space-y-4">
              <li><a href="/services#technical" className="text-sm leading-6 text-gray-300 hover:text-white">Technical SEO</a></li>
              <li><a href="/services#on-page" className="text-sm leading-6 text-gray-300 hover:text-white">On-Page SEO</a></li>
              <li><a href="/services#off-page" className="text-sm leading-6 text-gray-300 hover:text-white">Off-Page SEO</a></li>
              <li><a href="/services#local" className="text-sm leading-6 text-gray-300 hover:text-white">Local SEO</a></li>
            </ul>
          </div>
