'use client';
// src/app/case-studies/techflow-solutions/page.tsx

import { ChartBarIcon, StarIcon, CurrencyDollarIcon, CalendarIcon, ArrowTrendingUpIcon, CheckCircleIcon, SparklesIcon, UserGroupIcon, LinkIcon } from '@heroicons/react/24/solid';
import Image from 'next/image';
import { useEffect, useState } from 'react';

const metrics = [
  { label: 'Organic Traffic', value: 340, suffix: '%', icon: ChartBarIcon, color: 'text-green-400' },
  { label: 'Keyword Rankings (Top 3)', value: 450, suffix: '%', icon: StarIcon, color: 'text-blue-400' },
  { label: 'Lead Conversions', value: 85, suffix: '%', icon: CurrencyDollarIcon, color: 'text-purple-400' },
  { label: 'Revenue Growth', value: 220, suffix: '%', icon: ArrowTrendingUpIcon, color: 'text-emerald-400' },
];

const timeline = [
  { title: 'Challenge', desc: 'Stagnant organic growth and low conversion rates from search traffic.', icon: ExclamationIcon },
  { title: 'Strategy', desc: 'Comprehensive technical SEO audit, content optimization, and link building.', icon: SparklesIcon },
  { title: 'Results', desc: 'Explosive growth in traffic, leads, and revenue.', icon: CheckCircleIcon },
];
    ...
    <main className="bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950 min-h-screen text-white pb-16">
      ...
      <section className="relative overflow-hidden pt-16 pb-10 px-4 sm:px-0">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent mb-2 animate-fade-in">TechFlow Solutions</h1>
            <h2 className="text-lg text-green-400 font-semibold mb-2 animate-fade-in">SaaS Platform</h2>
            <p className="text-gray-300 max-w-2xl mx-auto animate-fade-in">Stagnant organic growth and low conversion rates from search traffic threatened TechFlow's expansion. SEOBuddy delivered a transformation.</p>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-4 mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-gray-800/80 rounded-xl p-6 flex flex-col items-center text-center shadow-lg animate-fade-in-up">
            ...
            <div className="font-semibold text-white mb-1">Technical SEO Audit</div>
            <div className="text-gray-400 text-sm">Identified and fixed site issues, improved crawlability, and enhanced site speed.</div>
          </div>
          <div className="bg-gray-800/80 rounded-xl p-6 flex flex-col items-center text-center shadow-lg animate-fade-in-up">
            <UserGroupIcon className="h-8 w-8 text-green-400 mb-2" />
            <div className="font-semibold text-white mb-1">Content Optimization</div>
            <div className="text-gray-400 text-sm">Refined messaging, improved keyword targeting, and boosted engagement.</div>
          </div>
          <div className="bg-gray-800/80 rounded-xl p-6 flex flex-col items-center text-center shadow-lg animate-fade-in-up">
            <LinkIcon className="h-8 w-8 text-purple-400 mb-2" />
            <div className="font-semibold text-white mb-1">Link Building</div>
            <div className="text-gray-400 text-sm">Secured high-quality backlinks to increase authority and rankings.</div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-2xl mx-auto px-4 mb-16 animate-fade-in">
        <div className="bg-gradient-to-r from-green-400/10 to-blue-400/10 border-l-4 border-green-400 rounded-lg p-8 shadow-lg">
          <p className="text-lg italic text-gray-200 mb-4">"SEOBuddy transformed our online presence completely. Their data-driven approach doubled our organic leads in just six months. The ROI has been incredible - we're seeing 15x return on our investment."</p>
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-400 rounded-full flex items-center justify-center text-white font-bold text-lg">SC</div>
            <div>
              <div className="text-white font-semibold">Sarah Chen</div>
              <div className="text-gray-400 text-sm">Marketing Director, TechFlow Solutions</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="fixed bottom-6 left-0 w-full flex justify-center z-40 animate-fade-in-up pointer-events-none">
        <a href="/contact" className="pointer-events-auto inline-block bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold py-4 px-10 rounded-full shadow-xl hover:from-green-500 hover:to-blue-600 transition-all text-lg animate-bounce">Start Your Success Story</a>
      </div>
    </main>
  );
}

// Animations (add to globals.css or use Tailwind plugin)
